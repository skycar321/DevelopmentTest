# Vue 3 draft kit — 2026-09-11

This directory holds one encrypted archive (`vue3-draft-kit-20260911.7z`, 7z AES-256 with
...
7z x -p<password> vue3-draft-kit-20260911.7z
```
