# Vue 3 developer tools — 20260923

This directory holds one encrypted archive (`vue3-dev-tools-20260923.7z`, 7z AES-256 with encrypted headers, 24 files)
...
7z x -p vue3-dev-tools-20260923.7z
