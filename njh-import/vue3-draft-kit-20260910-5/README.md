# Vue 3 draft kit — 2026-09-10 rev 5 (encrypted, lab tip 72d84cf5)

This directory publishes one archive, `vue3-draft-kit-20260910-5.7z`. It replaces rev 4.
...
```bash
shasum -a 256 -c sha256.txt          # or: certutil -hashfile vue3-draft-kit-20260910-5.7z SHA256
7z x -p vue3-draft-kit-20260910-5.7z # enter the password when prompted
```
