# Vue 3 developer tools — 20260922

This directory holds one encrypted archive (`vue3-dev-tools-20260922.7z`, 7z AES-256 with encrypted headers, 22 files)
...
7z x -p vue3-dev-tools-20260922.7z
