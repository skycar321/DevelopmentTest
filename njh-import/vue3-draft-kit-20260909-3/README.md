# Vue 3 draft kit — 2026-09-09 (encrypted, third cut: lab tip f591bd4e)

This directory publishes one archive, `vue3-draft-kit-20260909-3.7z`.
...
```bash
shasum -a 256 -c sha256.txt        # or: certutil -hashfile vue3-draft-kit-20260909-3.7z SHA256
7z x -p vue3-draft-kit-20260909-3.7z # enter the password when prompted
```
...
Third cut of the same day. Changes since `vue3-draft-kit-20260909-2`: the alert part now adopts every alert screen (90 of 90 — header-slot notices with
aliased class names are recognised), and nine excel-related skill test files were repaired. Fully automatic screens stay at 129 of 152; the remaining
23 carry precise refusal reasons and hand-work instructions in their receipts.
