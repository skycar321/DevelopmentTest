...
- 번들: `airflow-bundle-20260825_110311.7z` (1172337 bytes)
- sha256: `9aaea9a4c1eb9e09bebd62adea4910377fec9a088e44cad71c60e14352104109`
- source commit: `68f0e5af1`
...
```bash
bash docs/branch_report.sh                       # 기본: main dev airflow
BRANCHES="main release hotfix" bash docs/branch_report.sh
FOCUS="pom.xml build.gradle"   bash docs/branch_report.sh
```
...
```bash
7z x airflow-bundle-20260825_110311.7z   # 비밀번호 입력
