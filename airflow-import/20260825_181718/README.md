...
- 번들: `airflow-bundle-20260825_181718.7z` (1176017 bytes)
- sha256: `07563dbf37fd5f0e3f00b6f8b931ea153f3372c9e4b5a5be6a7921bd0c38bea5`
- source commit: `8652ba18a`
...
| 축 | 결과 |
|---|---|
| NM 검증 장치 7종 | 전부 rc=0 (계약 무결성·판정 순환·B6 캡처 대조·커버리지 512=324+188·자기검사 반례·Maven·shell) |
| OM 통합 스위트 | FAIL 39 → 24 (통과 235→260) (신규 FAIL 0) — 하니스 오참조 35곳 수리·계약 재조준의 실측 효과 |
| 검수 하니스 8종 (1920 실브라우저) | 전부 PASS |
| 셀렉터 전수 조사 5,732행 | 진짜 제품 갭 0 (ABSENT 는 전부 하니스결함/은퇴/픽스처/host 소유로 판명) |

남은 스위트 적색은 검증 장치·하니스 자체의 정비 항목이며 **반입 대상 제품 코드의 결함은 0** 입니다.

## 압축 해제

```bash
7z x airflow-bundle-20260825_181718.7z   # 비밀번호 입력
